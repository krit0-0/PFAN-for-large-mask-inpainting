...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        # training epoch
        parser.add_argument('--epoch', type=int, default=50, help='the ending epoch count')
        parser.add_argument('--iter_count', type=int, default=1, help='the starting epoch count')
        parser.add_argument('--niter', type=int, default=500000, help='# of iter with initial learning rate')
        ...
        parser.add_argument('--beta2', type=float, default=0.999, help='initial learning rate for adam')
