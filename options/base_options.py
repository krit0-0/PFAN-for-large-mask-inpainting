...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--model', type=str, default='panoramic', help='name of the model type. [pluralistic]')
        parser.add_argument('--mask_type', nargs='+', type=int, default=[0, 2],
        ...
        parser.add_argument('--gpu_ids',  type=str, default='0', help='gpu ids: e.g. 0, 1, 2 use -1 for CPU') # nargs='+',
