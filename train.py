...
# python train.py --no_flip --no_rotation --no_augment --img_file "/media/lab225-2/disk1/WBY/datasets/celeba-256" --lr 1e-4 --mask_type 0 --gpu_ids 0 --batchSize 4
...
if __name__ == '__main__':
    ...
    while(keep_training):
        ...
        for i, data in enumerate(dataset):
            ...
            if total_iteration > max_iteration or epoch > opt.epoch:
                keep_training = False
                break
