...
if __name__ == '__main__':
    folder1 = r'D:\111www\Panoramic Feature Aggregation Network for Large Mask Inpainting\论文图表\compare\TFill_results\celeba-4'      #'path to the inpainted result'
    #C:\Users\ww\Desktop\evaluation\celeba_test\out3.0_10rec_mask2
    folder2 = r'D:\111www\Panoramic Feature Aggregation Network for Large Mask Inpainting\evaluation-test1\celeba_test\truth2'      #'path to the gt'
    #C:\Users\ww\Desktop\evaluation\celeba_test\truth
    #C:\Users\ww\Desktop\evaluation\paris_test\truth
